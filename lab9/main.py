...
from scipy.io.wavfile import write  # правильный импорт write для WAV
...
# ─── main() ───────────────────────────────────────────────────────────────────
def main():
    # 1) Запись (раскомментируйте при необходимости)
